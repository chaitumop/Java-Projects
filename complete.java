...
class VCI {
	...
	//		System.out.println("ENTER YES TO ENTER OTHERWISE NO");
			...
			String s3="no";
	//here we entered a loop which ask the user whether he/she wants to enter or not		
	...
	System.out.println("WOULD YOU LIKE TO ENTER AGAIN  IF YES PRESS YES OTHERWISW NO");
